...
app.post("/payment/driver/:id/attach", verifyToken, attachPaymentMethodDriver);
...
app.post("/payment/driver/payout", driverPayout);
...
// taxi
app.get("/taxi/all", cors(), getAllTaxi);
app.get("/taxi/details/:id", cors() , getTaxiCode);
app.post("/taxi/add", cors() , addTaxiCode);
app.post("/taxi/edit/:id", cors(), editTaxiCode);
app.delete("/taxi/delete/:id", cors(), deleteTaxiCode);
...
const {checkNotification} = require("./services/testNotification");
app.post("/api/test_notif", cors(), checkNotification);
...
app.get("/service-areas", cors(),verifyToken, getAllServiceAreas);
app.get("/service-areas/:id", cors(),verifyToken, getServiceAreaById);
app.post("/service-areas", cors(),verifyToken, addServiceArea);
app.put("/service-areas/:id", cors(),verifyToken, updateServiceArea);
app.delete("/service-areas/:id", cors(),verifyToken, deleteServiceArea);

const onboardingRoutes = require('./routes/onboarding');
app.use('/onboarding', onboardingRoutes);
app.delete("/payment/account/:id", deleteStripeAccount);

...
const addCopyright = async (req, res) => {
  const latestTermsParams = {
    TableName: "copyrightTable",
  };
...
const retrieveLatestCopyright = async (req, res) => {
...
const retrieveSpecificVersionCopyright = async (req, res) => {
  const params = {
    TableName: "copyrightTable",
...
const listAllCopyright = async (req, res) => {
  const params = {
    TableName: "copyrightTable", // Replace with your table name
  };

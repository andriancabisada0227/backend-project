...
const addPrivacyPolicy = async (req, res) => {
  ...
  try {
    ...
    return res.status(201).json({
      success: true,
      message: "Privacy Policy data added successfully!",
      version,
    });
  } catch (error) {
...
const retrieveLatestPrivacyPolicy = async (req, res) => {
...
const retrieveSpecificVersionPrivacyPolicy = async (req, res) => {
  const params = {
    TableName: "privacyPolicyTable",
...
const listAllPrivacyPolicy = async (req, res) => {
  const params = {
    TableName: "privacyPolicyTable", // Replace with your table name
  };
